...
public class Main {
    public static void main(String[] args) {
        MongoClient mongoClient = MongoClients.create("mongodb+srv://root:root@showbts.awa5m.mongodb.net/?retryWrites=true&w=majority&appName=ShowBts");

        MongoDatabase database = mongoClient.getDatabase("meubanquinho");
